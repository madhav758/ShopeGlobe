            ...
            <div className="bg-transparent ">
                <div className="mx-auto max-w-2xl px-4 pt-16 pb-24 sm:px-6 lg:max-w-7xl lg:px-8">
                    ...
                    <form className="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
                        ...
                        <section aria-labelledby="summary-heading" className="mt-16 rounded-lg bg-neutral-900 px-4 py-6 sm:p-6 lg:col-span-5 lg:mt-0 lg:p-8">
                            <CheckoutPage />
                            ...
                            <div className="mt-6 text-center text-sm">
                                <p>
                                    or{' '}
                                    <Link to={'/'}>
                                        <button type="button" className="font-medium text-gray-300 hover:text-white transition-colors">
